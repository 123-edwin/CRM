...
export function Contrato() {
  ...
  return (
    ...
    <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', mt: 2 }}>
        ...
        <Button startDecorator={<Add />} type="button" size="sm">Nuevo contrato</Button>
        </Link>
    </Box>
...
sx={{bgcolor: 'background.level1',borderRadius: 'sm',p: 2,my: 1.5,display: 'flex',gap: 2,'& > div': { flex: 1 },}}>
    ...
    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
        ...
        <Typography level="body-xs" sx={{ fontWeight: 'lg', color: '#0378ac',fontSize: '1rem'}}>Activo</Typography>
    </Box>
    
    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
        <Typography sx={{ fontWeight: 'lg',fontSize: '0.9rem' }}>0</Typography>
        <Typography level="body-xs" sx={{ fontWeight: 'lg', color: '#b40202',fontSize: '1rem'}}>Expirado</Typography>
    </Box>

    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
        <Typography sx={{ fontWeight: 'lg',fontSize: '0.9rem' }}>0</Typography>
        <Typography level="body-xs" sx={{ fontWeight: 'lg', color: '#bb8a00',fontSize: '1rem' }}>A punto de caducar</Typography>
    </Box>

    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
        <Typography sx={{ fontWeight: 'lg',fontSize: '0.9rem' }}>0</Typography>
        <Typography level="body-xs" sx={{ fontWeight: 'lg', color: '#239d02',fontSize: '1rem' }}>Recientemente añadido</Typography>
    </Box>

    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
        <Typography sx={{ fontWeight: 'lg',fontSize: '0.9rem' }}>0</Typography>
        <Typography level="body-xs" sx={{ fontWeight: 'lg',fontSize: '1rem'}}>Basura</Typography>
    </Box>
...
<Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}>
  <Box sx={{ display: 'flex', gap: 2 }}>
    ...
    <Box sx={{
      ...
      <Typography level="h6">Importes de contratos por tipos ( MX )</Typography>
