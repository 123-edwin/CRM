...
<Box sx={{mt: 1,display: 'flex',justifyContent: 'space-between',alignItems: 'center',flexDirection: { xs: 'column', sm: 'row' }}}>
  {/* Botón a la izquierda */}
  <Button variant="outlined" color="neutral">Download Sample</Button>

  {/* Botones a la derecha */}
  <Box sx={{display: 'flex',gap: 1,mt: { xs: 1, sm: 0 },}}>
    <Button variant="solid" color="primary">Importar</Button>
    <Button variant="outlined" color="neutral">Simular importación</Button>
  </Box>
</Box>
