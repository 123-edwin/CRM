...
export function Miperfil() {
    ...
    <Box sx={{ width: '100%', position: 'relative', overflow: { xs: 'auto', sm: 'initial' },}}> <Box/>
      ...
      <Card
        ...
        <CardContent>
          ...
          <Sheet
            ...
            <div>
              <Typography level="body-xs" sx={{ fontWeight: 'lg' }}>
                Tiempo total mensualmente
              </Typography>
              <Typography sx={{ fontWeight: 'lg' }}>00:00</Typography>
            </div>
            <div>
              <Typography level="body-xs" sx={{ fontWeight: 'lg' }}>
              Tiempo total semanalmente
              </Typography>
              <Typography sx={{ fontWeight: 'lg' }}>00:00</Typography>
            </div>
          </Sheet>
          ...
          <Box sx={{ display: 'flex', gap: 2, mt: 2, '& > button': { borderRadius: '2rem' }, }}>
